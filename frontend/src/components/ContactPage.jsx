...
import { AlertCircle, User, Mail, Phone, Clock, ShoppingCart, IndianRupee, MapPin ,
...
const ContactPage = () => {
 ...
 // to submit and redirect  to watshapp
            ...
            <InputWithIcon 
              icon={<IndianRupee className=" w-5 h-5 text-green-600"/>}
               ...
               <div>
                ...
                onChange={handleChange}
                rows={4}
                className={`${contactPageStyles.messageInput} ${
                    errors.message 
