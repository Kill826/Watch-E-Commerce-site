...
import { BaggageClaim, Clock, User, Menu, X } from 'lucide-react';
...
!!localStorage.getItem("authToken")   // FIXED spelling
);
} catch {
return false;
}
...
return ( <header className={navbarStyles.header}> <nav className={navbarStyles.nav} role='navigation'>
