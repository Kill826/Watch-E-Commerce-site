...
import { FILTERS as RAW_FILTERS,WATCHES as DUMMY_WATCHES} from '../assets/dummywData';
import {useCart } from '../CartContext';
import { Icon , Grid, User, Users, ShoppingCart, Plus, Minus} from 'lucide-react';
...
const WatchPage = () => {
  ...
  // to normalized server items coming to UI shap
    ...
    <div className={watchPageStyles.container}>
      ...
      <div className={watchPageStyles.headerContainer}>
          ...
          <p className={watchPageStyles.headerDescription}>
            A handpicked selection - clean presntation, zero borders. 
