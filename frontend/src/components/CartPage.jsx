...
import axios from 'axios';
 ...
 // we have  to create  a producutItem where a
...
//maxium digits for mobile number is 10
...
//check from is filled or not by the user
    ...
    return(
        ...
        <div className={cartPageStyles.emptyCartCard}>
            ...
            <p className={cartPageStyles.emptyCartText}>
                Look like you haven't added any watches to your cart yet.
               </p>
           ...
           <form onSubmit={handleSubmit} className={cartPageStyles.form}>
            ...
            <input
             ...
             onChange={(e) => setNote(e.target.value)}
               placeholder="Message / delivery instrucutions"  
               rows={2} 
               className={cartPageStyles.textareaBase}
               ></textarea>
