...
// any input change given by user in the input fileds of image
...
//after submit rest the from to it's inital value    
  const resetForm = () => {
    setName("");
    setDescription("");
    setPrice("");
    ...
    <div className={`${classes.pageContainer} ${theme.bg}`}>
      ...
      <div className={classes.maxWidthContainer}>
        ...
        <div className={classes.themeButtonsContainer}>
            ...
            <button 
            key={c}
            className={`${classes.themeButton(activeColor === c)}
             ${themeButtonColors[c]}
             `}
       ...
       <div className={classes.gridContainer}>
        <form onSubmit={handleSubmit} className={classes.formContainer(theme)}>
                ...
                <div className={classes.formLabel}>
                  ...
                  <div className="flex items-center gap-4">
                    <div className={`${classes.imagePreviewContainer(theme)} ${
                     ...
                     {imagePreviewUrl ? (
                      <img src={imagePreviewUrl} alt="previwe"
           ...
           placeholder="e.g. Classic Silver Chorono"
