...
export const clearUserCart = async(req,res) => {
    ...
    return res.status(500).json({ success: false, message: "Error clearing the cart", error: error.message });
  }
